...
paymentRoutes.route('/paypalCallback',{
   //name: "process",
   triggersEnter: [trackRouteEntry, paypalParam],
    action(params) {
        console.log(params);
        //BlazeLayout.render('default', { top: 'topnav', main: 'process', bottom: 'footer'}
    }
});
